...
" Generated by http://bytefluent.com/vivify 2012-03-13
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi IncSearch guifg=#ffffff guibg=#8a0404 guisp=#8a0404 gui=NONE ctermfg=15 ctermbg=88 cterm=NONE
...
hi Search guifg=#ffffff guibg=#470101 guisp=#470101 gui=NONE ctermfg=15 ctermbg=52 cterm=NONE
