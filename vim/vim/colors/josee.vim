...
" vim: tw=0 ts=4 sw=4
" Vim color file
" Maintainer:   Jose Eterovic <josee@synopsys.com>
" Last Change:  2008 Jan 04
...
hi Constant       term=underline  cterm=bold ctermfg=grey  guifg=#ffa0a0
